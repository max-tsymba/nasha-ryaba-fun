...
/*!************************!*\
  !*** ./app/js/main.js ***!
  \************************/
/*! no exports provided */function(module,__webpack_exports__,__webpack_require__){"use strict";eval('__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_libs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/libs */ "./app/js/modules/libs.js");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }\n\n/*====================================IMPORT MODULES====================================*/\n\n/*======================================================================================*/\n\n/*======================================DOM LOADED======================================*/\n\nwindow.addEventListener(\'DOMContentLoaded\', function () {\n  Object(_modules_libs__WEBPACK_IMPORTED_MODULE_0__["burgerOpener"])(\'burger\', \'.header__menu\', \'.header__menu-close\', \'.header__menu-link\');\n  Object(_modules_libs__WEBPACK_IMPORTED_MODULE_0__["burgerOpener"])(\'reg__button\', \'#overlay\', \'.close-btn\');\n});\n/*======================================================================================*/\n\nwindow.onload = function () {\n  AOS.init();\n  $(".phone").mask("380999999999", {\n    placeholder: "380_________"\n  }); //Send form\n\n  var formBlock = document.getElementsByTagName("form")[0];\n\n  if (formBlock !== undefined) {\n    formBlock.addEventListener("submit", /*#__PURE__*/function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {\n        var formBlock_CodeInput, xhr, data, url, method, result_Block, submit_button, loader;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                formBlock_CodeInput = formBlock.querySelector("input[name=\'code\']");\n                event.preventDefault(); //Values\n\n                xhr = new XMLHttpRequest(), data = new FormData(event.target), url = formBlock.getAttribute("action"), method = formBlock.getAttribute(\'method\'), result_Block = formBlock.querySelector(".result-text"), submit_button = formBlock.querySelector("input[type=\'submit\'], button[type=\'submit\']"), loader = formBlock.getElementsByClassName("loader")[0]; //Disable submit-button\n\n                submit_button.disabled = true; //Show loader\n\n                loader.classList.add(\'active\');\n                grecaptcha.ready(function () {\n                  grecaptcha.execute(\'6Ld13OcaAAAAAG8rKkfe0ykgiS7fp4Z1wjE8uYL1\', {\n                    action: \'submit\'\n                  }).then(function (token) {\n                    //Add token\n                    data.append(\'g-recaptcha-response\', token); //Send request\n\n                    xhr.open(method, url);\n                    xhr.responseType = \'text\';\n                    xhr.setRequestHeader("Cache-Control", "no-cache");\n                    xhr.setRequestHeader("redirect", "follow");\n                    xhr.setRequestHeader("referrerPolicy", "no-referrer");\n                    xhr.setRequestHeader("mode", "cors");\n                    xhr.setRequestHeader("X-Requested-With", "XMLHttpRequest");\n\n                    xhr.onload = function () {\n                      submit_button.disabled = false;\n                      loader.classList.remove(\'active\');\n\n                      if (this.status >= 200 && this.status < 300) {\n                        result_Block.style.color = "#44944A";\n                      } else {\n                        result_Block.style.color = "#F13A13"; //Clear input\n\n                        formBlock_CodeInput.value = null; //grecaptcha.reset();\n                      }\n\n                      result_Block.textContent = this.status >= 500 ? "Час очікування відповіді сервера минув" : this.response;\n                    };\n\n                    xhr.send(data);\n                  });\n                });\n\n              case 6:\n              case "end":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }));\n\n      return function (_x) {\n        return _ref.apply(this, arguments);\n      };\n    }());\n  }\n};\n\n//# sourceURL=webpack:///./app/js/main.js?')},"./app/js/modules/libs.js":
/*!********************************!*\
  !*** ./app/js/modules/libs.js ***!
  \********************************/
/*! exports provided: burgerOpener, modalOpener */function(module,__webpack_exports__,__webpack_require__){"use strict";eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"burgerOpener\", function() { return burgerOpener; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"modalOpener\", function() { return modalOpener; });\n/*=====================================BURGER MENU======================================*/\nvar burgerOpener = function burgerOpener(burgerID, menuSelector, closeBtnSelector) {\n  var menuLinksSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;\n  var burgerBtn = document.getElementById(burgerID),\n      menu = document.querySelector(menuSelector),\n      links = document.querySelectorAll(menuLinksSelector),\n      closeBtn = document.querySelector(closeBtnSelector);\n  if (burgerBtn !== null) burgerBtn.addEventListener('click', function () {\n    return menu.classList.add('opened');\n  });\n\n  if (closeBtn !== null) {\n    closeBtn.addEventListener('click', function () {\n      return menu.classList.remove('opened');\n    });\n    links.forEach(function (link) {\n      link.addEventListener('click', function () {\n        menu.classList.remove('opened');\n      });\n    });\n\n    if (menuSelector === '#overlay') {\n      menu.addEventListener('click', function (e) {\n        if (e.target === menu) {\n          menu.classList.remove('opened');\n        }\n      });\n    } else {\n      document.body.addEventListener('click', function (e) {\n        if (e.target !== menu && e.target !== burgerBtn && e.target !== document.querySelector('.burger-line')) {\n          menu.classList.remove('opened');\n        }\n      });\n    }\n  }\n};\n/*======================================================================================*/\n\n/*=====================================MODAL OPENER=====================================*/\n\n\nvar modalOpener = function modalOpener() {\n  function bindModal(overlaySelector, formID, openBtnSelector, closeBtnSelector) {\n    var inputWrapperSelector = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;\n    var errorLabel = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;\n    var overlay = document.querySelector(overlaySelector),\n        modal = document.getElementById(formID),\n        openBtn = document.querySelectorAll(openBtnSelector),\n        closeBtn = document.querySelectorAll(closeBtnSelector);\n    var removeScroll = calcScroll();\n    var isWrapper = false;\n\n    if (inputWrapperSelector !== null) {\n      var _wrappers = document.querySelectorAll(inputWrapperSelector),\n          _labels = document.querySelectorAll(errorLabel);\n\n      isWrapper = true;\n    }\n\n    if (modal !== null) {\n      openBtn.forEach(function (btn) {\n        btn.addEventListener('click', function () {\n          overlay.classList.add('active');\n          modal.classList.add('active');\n          document.body.style.overflowY = 'hidden';\n          document.body.style.marginRight = \"\".concat(scroll, \"px\");\n        });\n      });\n      closeBtn.forEach(function (btn) {\n        btn.addEventListener('click', function () {\n          overlay.classList.remove('active');\n          modal.classList.remove('active');\n          document.body.style.overflowY = 'scroll';\n          document.body.style.marginRight = \"0px\";\n\n          if (isWrapper) {\n            clearErrors(labels, wrappers);\n            Reset(modal);\n          }\n        });\n      });\n      overlay.addEventListener('click', function (e) {\n        if (e.target === overlay) {\n          overlay.classList.remove('active');\n          modal.classList.remove('active');\n          document.body.style.overflowY = 'scroll';\n          document.body.style.marginRight = \"0px\";\n\n          if (isWrapper) {\n            clearErrors(labels, wrappers);\n            Reset(modal);\n          }\n        }\n      });\n    }\n\n    ;\n  }\n\n  ;\n};\n\nfunction calcScroll() {\n  var div = document.createElement('div');\n  div.style.width = '50px';\n  div.style.height = '50px';\n  div.style.overflowY = 'scroll';\n  div.style.visibility = 'hidden';\n  document.body.appendChild(div);\n  var scrollWidth = div.offsetWidth - div.clientWidth;\n  div.remove();\n  return scrollWidth;\n}\n\nfunction clearErrors(labelError, inputsError) {\n  labelError.forEach(function (item) {\n    item.style.display = 'none';\n  });\n  inputsError.forEach(function (item) {\n    item.classList.remove('_error');\n  });\n}\n\nfunction Reset(form) {\n  form.reset();\n}\n/*======================================================================================*/\n\n\n\n\n//# sourceURL=webpack:///./app/js/modules/libs.js?")},"./node_modules/babel-polyfill/lib/index.js":
/*!**************************************************!*\
